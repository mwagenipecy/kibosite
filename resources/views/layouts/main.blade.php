            ...
            <div class="flex justify-between h-20">
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex-shrink-0 flex items-center">
                        <img class="h-12 w-auto" src="{{ asset('images/kibo-logo.svg') }}" alt="Kibo Capital Logo">
                    </a>
                </div>
    ...
    <footer class="bg-kibo-dark text-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    <img class="h-12 w-auto mb-6" src="{{ asset('images/kibo-logo-white.svg') }}" alt="Kibo Capital Logo">
                    <p class="text-gray-300 mb-6">Kibo Capital is a leading investment firm focused on delivering exceptional returns through strategic investments and partnerships.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Investment Management</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Financial Planning</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Wealth Management</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Tax Strategy</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <svg class="h-6 w-6 mr-2 text-kibo-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            <span class="text-gray-300">123 Business Avenue, Suite 500<br>Financial District, City 12345</span>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="text-gray-300">info@kibocapital.com</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-gray-700 mt-12 pt-8 text-center">
                <p class="text-gray-300">&copy; {{ date('Y') }} Kibo Capital. All rights reserved.</p>
            </div>
        </div>
    </footer>
