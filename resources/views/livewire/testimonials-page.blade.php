            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <p class="text-xl md:text-2xl text-gray-200 mb-8 animate-slide-up leading-relaxed">
                        See how Kibo Capital Limited’s integrity, professionalism, and excellence have made a difference on our clients’ major construction and engineering projects.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto text-center mb-16">
                    <h2 class="text-kibo-blue text-lg font-semibold mb-2 animate-on-scroll">PROJECT STORIES</h2>
                    ...
                    <p class="text-lg text-gray-600 animate-on-scroll">
                        See how our commitment to quality, safety, and collaboration has impacted our clients’ building and infrastructure projects.
                    </p>
                </div>
                    ...
                    <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-lg animate-on-scroll">
                        <div class="relative aspect-w-16 aspect-h-9">
                            ...
                            <div
                                ...
                                style="background-image: url('{{ asset('/profile/image copy.png') }}');"
                        ...
                        <div class="p-6">
                            <div class="flex items-center mb-4">
                                <img src="{{ asset($testimonial['image'] ?'/profile/image copy.png':'/profile/image copy.png') }}" alt="{{ $testimonial['name'] }}" class="w-12 h-12 rounded-full mr-4">
                                <div>
        ...
        <section class="py-20 bg-gray-50">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto text-center mb-16">
                    ...
                    <p class="text-lg text-gray-600 animate-on-scroll">
                        Our clients’ satisfaction is our proudest accomplishment. Here’s what they say about partnering with Kibo Capital Limited on their construction and engineering projects.
                    </p>
                </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="p-6 sm:p-8">
                            ...
                            <div class="mb-6 aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden">
                                ...
                                <div class="flex items-center justify-center">
                                    <div class="text-center p-4">
                                        ...
                                        <p class="text-gray-600">Watch Testimonial Video</p>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="mt-8 pt-6 border-t border-gray-200">
                                <h4 class="font-semibold text-kibo-dark mb-2">Project Category:</h4>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                    ...
                    <div class="animate-on-scroll">
                        ...
                        <div class="text-lg text-gray-300">Projects Completed</div>
                    </div>
                    <div class="animate-on-scroll">
                        <div class="text-4xl font-bold mb-2">150+</div>
                        <div class="text-lg text-gray-300">Clients Served</div>
                    </div>
                    <div class="animate-on-scroll">
                        <div class="text-4xl font-bold mb-2">95%</div>
                        <div class="text-lg text-gray-300">On-Time Delivery</div>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-gray-600 mb-8 animate-on-scroll">
                Join our partners and discover how our construction expertise and collaborative approach can bring your project vision to life.
            </p>
            <div class="animate-on-scroll">
